if (sim_call_type==sim_childscriptcall_initialization) then
    ...
    init_pose=io.open("/home/ratneshmadaan/projects/riss_bingham/data/cuboid/20160711/init_pose.csv", "w");
    final_pose=io.open("/home/ratneshmadaan/projects/riss_bingham/data/cuboid/20160711/final_pose.csv", "w");
    init_pose_euler=io.open("/home/ratneshmadaan/projects/riss_bingham/data/cuboid/20160711/init_pose_euler.csv", "w");
    final_pose_euler=io.open("/home/ratneshmadaan/projects/riss_bingham/data/cuboid/20160711/final_pose_euler.csv", "w");
